...
export function About() {
  return <section id="about" className="page-section about-section"><AmbientBackground variant="about" /><div className="container about-grid">
    ...
    <Reveal className="about-cta"><a className="btn btn-primary" href={whatsappUrl} target="_blank" rel="noreferrer">{copy.about.ctaLabel} <MessageCircle aria-hidden="true" /></a></Reveal>
  </div></section>;
}
